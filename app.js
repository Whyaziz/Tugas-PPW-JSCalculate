...
function calculate(){
  ...
  try{
    document.getElementById("Kalkulator").addEventListener("submit", (x) => {
      ...
      var sampah1 = parseFloat(document.getElementById("sampah1").value)
      var sampah2 = parseFloat(document.getElementById("sampah2").value)
      var sampah3 = parseFloat(document.getElementById("sampah3").value)
